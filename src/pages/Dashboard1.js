    ...
    <div className="relative bg-ghostwhite w-full h-[1024px] overflow-hidden text-left text-sm text-light-bulma1 font-montserrat">
      ...
      <div className="absolute top-[699px] left-[910px] w-[480px] h-64 text-base text-secondary-text font-paragraph-text-md-s">
        ...
        <div className="absolute h-[45.62%] w-[17.08%] top-[27.19%] right-[41.46%] bottom-[27.19%] left-[41.46%] flex flex-col items-center justify-center gap-[16px]">
          <img
            className="relative w-[76.78px] h-[76.78px]"
            alt=""
            src="/group-75581.svg"
          />
      ...
      <div className="absolute top-[calc(50%_-_276.5px)] left-[calc(50%_-_272px)] rounded-2xl bg-light-goten shadow-[0px_32px_32px_-8px_rgba(0,_0,_0,_0.08),_0px_0px_32px_-8px_rgba(0,_0,_0,_0.12),_0px_0px_1px_rgba(0,_0,_0,_0.2)] w-[544px] h-[553px] text-xl text-light-bulma font-paragraph-text-md-s">
        <div className="absolute top-[0px] left-[0px] w-[544px] h-16 flex flex-col items-center justify-between pt-4 px-0 pb-0 box-border">
          <div className="self-stretch flex flex-row items-center justify-between py-0 px-6">
        ...
        <div className="absolute top-[63px] left-[0px] w-[544px] h-[376px] flex flex-col items-start justify-start p-6 box-border gap-[24px] text-base">
          ...
          <div className="flex flex-col items-start justify-start">
            <div className="w-[496px] flex flex-col items-start justify-start gap-[8px]">
              ...
              <div className="self-stretch rounded-lg bg-light-goten flex flex-col items-start justify-start py-3 px-4 text-light-trunks border-[1px] border-solid border-light-beerus-beerus">
                <div className="self-stretch relative leading-[24px]">
                  Eg. John Doe
                </div>
              </div>
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[8px] text-light-bulma1">
            ...
            <div className="self-stretch rounded-lg bg-light-goten overflow-hidden flex flex-row items-center justify-between p-3 text-center text-3xs text-light-goten border-[1px] border-solid border-light-beerus-beerus">
              <div className="hidden flex-row items-start justify-start gap-[4px]">
                <div className="rounded bg-light-piccolo-piccolo overflow-hidden flex flex-row items-center justify-start py-1 pr-1 pl-2 gap-[4px]">
                  <div className="relative tracking-[0.5px] leading-[16px] uppercase font-semibold">
                    TAG 1
                  </div>
                  <img className="relative w-4 h-4" alt="" src="/icon3.svg" />
                </div>
                <div className="rounded bg-light-piccolo-piccolo overflow-hidden flex flex-row items-center justify-start py-1 pr-1 pl-2 gap-[4px]">
                  <div className="relative tracking-[0.5px] leading-[16px] uppercase font-semibold">
                    TAG 2
                ...
                <div className="rounded bg-light-piccolo-piccolo overflow-hidden hidden flex-row items-center justify-start py-1 pr-1 pl-2 gap-[4px]">
                  <div className="relative tracking-[0.5px] leading-[16px] uppercase font-semibold">
                    your label
                  </div>
                  <img className="relative w-4 h-4" alt="" src="/icon3.svg" />
        ...
        <div className="absolute top-[465px] left-[4px] w-[544px] h-[88px] text-center text-sm text-light-trunks font-avertastd-semibold">
          ...
          <div className="absolute top-[24px] left-[0px] w-[544px] flex flex-row items-center justify-between py-0 px-6 box-border">
            <div className="rounded-lg overflow-hidden flex flex-row items-center justify-center py-2 px-4">
              <div className="relative leading-[24px]" />
            </div>
            <div
              className="flex flex-row items-start justify-start cursor-pointer text-light-goten font-paragraph-text-md-s"
