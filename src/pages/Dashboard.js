  ...
  return (
    <div className="relative bg-ghostwhite w-full h-[1024px] overflow-hidden text-left text-sm text-light-bulma1 font-montserrat">
      ...
      <div className="absolute top-[calc(50%_-_231.5px)] left-[calc(50%_-_272px)] rounded-2xl bg-light-goten shadow-[0px_32px_32px_-8px_rgba(0,_0,_0,_0.08),_0px_0px_32px_-8px_rgba(0,_0,_0,_0.12),_0px_0px_1px_rgba(0,_0,_0,_0.2)] w-[544px] h-[463px] flex flex-col items-start justify-start text-xl text-light-bulma font-paragraph-text-md-s">
        <div className="self-stretch h-16 flex flex-col items-center justify-between pt-4 px-0 pb-0 box-border">
        ...
        <div className="self-stretch flex flex-col items-start justify-start p-6 gap-[24px] text-base">
        ...
        <div className="self-stretch h-[88px] flex flex-col items-start justify-start pt-0 px-0 pb-6 box-border gap-[24px] text-center text-sm text-light-trunks font-avertastd-semibold">
          ...
          <div className="self-stretch flex flex-row items-center justify-between py-0 px-6">
            ...
            <div className="flex flex-row items-start justify-start gap-[8px] text-light-bulma font-paragraph-text-md-s">
              <div
                className="rounded-lg overflow-hidden flex flex-row items-center justify-center py-2 px-4 cursor-pointer border-[1px] border-solid border-light-trunks"
              ...
              <div className="rounded-lg bg-dodgerblue-100 overflow-hidden flex flex-row items-center justify-center py-2 px-4 text-light-goten">
                <div
                  className="relative leading-[24px] font-semibold cursor-pointer"
                  onClick={onButtonText2Click}
                >
                  Done
                </div>
              </div>
